...
//   // This is the key function to handle group changes.
...
//     // The `groups` field in the user serializer expects a list of group UUIDs.
//     // To move a user to a new group, we update their `groups` list.
//     // To detach a user, we send an empty list.
